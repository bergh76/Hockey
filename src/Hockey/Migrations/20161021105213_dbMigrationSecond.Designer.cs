...
namespace Hockey.Migrations
{
    ...
    [Migration("20161021105213_dbMigrationSecond")]
    partial class dbMigrationSecond
    {
            ...
            modelBuilder.Entity("HockeyWebPage.Models.Player", b =>
                {
                    ...
                    b.Property<int?>("_MakerCardManufactureId");
                    ...
                    b.HasIndex("_MakerCardManufactureId");
            ...
            modelBuilder.Entity("HockeyWebPage.Models.Player", b =>
                {
                    ...
                    b.HasOne("HockeyWebPage.Models.CardManufacture", "_Maker")
                        .WithMany()
                        .HasForeignKey("_MakerCardManufactureId");
                });
